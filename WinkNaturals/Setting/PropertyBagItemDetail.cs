...
namespace WinkNaturals.Setting
{
    public class PropertyBagItemDetail : IPropertyBagItem
    {
        ...
        private List<Item> GetStaticKitChildren(List<string> itemCode, GetItemsRequest request)
        {
        ...
        private IEnumerable<Item> GetItems(GetItemsRequest request, bool includeItemDescriptions = true)
        {
            // If we don't have what we need to make this call, stop here.
        ...
        private void PopulateGroupMembers(IEnumerable<Item> items, GetItemsRequest request)
        {
            int languageID = request.LanguageID;
            string currencyCode = request.Configuration.CurrencyCode;
            int warehouseID = request.Configuration.WarehouseID;
        ...
        private void PopulateItemImages(IEnumerable<Item> items)
        {
            foreach (var item in items)
            {
